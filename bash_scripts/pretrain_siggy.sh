...
if [ "$dataset" = "ukbb" ]; then
    ...
    data_path="/home/oturgut/data/processed/signalnet/data_train_all.pt"
    val_data_path="/home/oturgut/data/processed/signalnet/data_val_all.pt"
else
