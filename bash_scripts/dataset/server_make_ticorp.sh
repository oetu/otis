...
#SBATCH --output=/vol/aimspace/users/tuo/otis/slurm_output/data/ticorp-%A.out   # Standard output of the script (Can be absolute or relative path). %A adds the job id to the file name so you can launch the same script multiple times and get different logging files
#SBATCH --error=/vol/aimspace/users/tuo/otis/slurm_output/data/ticorp-%A.err    # Standard error of the script
...
#SBATCH --mem=256G          # Memory in GB (Don't use more than 128G per GPU)
