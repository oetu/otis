                    ...
                    do
                        ...
                        do
                            ...
                            if [ "$model_size" = "baseDeep" ]; then
                                # finetune="/vol/aimspace/users/tuo/SiT/output/pre/otis/ticorp/cos_weight0.0/ncc_weight0.1/seed0/baseDeep_dec128d2b/t1008/p1x24/wd0.15/m0.75/pre_b3712_blr1e-5/checkpoint-96-ncc-0.8654.pth"
