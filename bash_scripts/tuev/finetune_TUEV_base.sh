...
wandb_project="OTiS_TUEV_Classification"
wandb_id=""
...
# Data path
if [ "$path" = "tower" ]; then
    data_base="/home/oturgut/data/processed/TUEV"
    checkpoint_base="/home/oturgut/otis"
else
    data_base="/vol/aimspace/users/tuo/data/processed/TUEV"
    checkpoint_base="/vol/aimspace/users/tuo/otis"
fi

# Dataset parameters
# Training
data_path=$data_base"/train/data.pt"
labels_path=$data_base"/train/labels.pt"
downstream_task="classification"
nb_classes="6"

# Validation 
val_data_path=$data_base"/val/data.pt"
val_labels_path=$data_base"/val/labels.pt"

# Test 
test="True"
test_data_path=$data_base"/test/data.pt"
test_labels_path=$data_base"/test/labels.pt"
...
# eval_ckpt="checkpoint-24-acc_balanced-73.6831.pth"
# blr=(1e-4)
# # val_data_path=$data_base"/val/data.pt"
# # val_labels_path=$data_base"/val/labels.pt"
# val_data_path=$data_base"/test/data.pt"
# val_labels_path=$data_base"/test/labels.pt"
                    ...
                    do
                        ...
                        do
                            ...
                            if [ "$model_size" = "baseDeep" ]; then
                                # finetune="/vol/aimspace/users/tuo/otis/output/pre/otis/ticorp/cos_weight0.0/ncc_weight0.1/seed0/baseDeep_dec128d2b/t1008/p1x24/wd0.15/m0.75/pre_b3712_blr1e-5/checkpoint-96-ncc-0.8654.pth"
