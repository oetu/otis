                    ...
                    do
                        ...
                        do
                            ...
                            if [ "$model_size" = "baseDeep" ]; then
                                ...
                                # 1%
                                # finetune="/vol/aimspace/users/tuo/otis/output/pre/otis/ticorp_1percent/multivariate/domain_specific/dual_masking/cos_weight0.0/ncc_weight0.1/seed0/largeDeep_dec160d4b/t1008/p1x24/wd0.15/m0.75/pre_b256_blr3e-5/checkpoint-197-ncc-0.7532.pth"

                                # 10%
                                # finetune="/vol/aimspace/users/tuo/otis/output/pre/otis/ticorp_10percent/multivariate/domain_specific/dual_masking/cos_weight0.0/ncc_weight0.1/seed0/largeDeep_dec160d4b/t1008/p1x24/wd0.15/m0.75/pre_b1840_blr1e-5/checkpoint-194-ncc-0.8581.pth"
                            else
                                # huge
