...
#SBATCH --job-name=bm_huge
#SBATCH --output=/vol/aimspace/users/tuo/otis/slurm_output/fin/bm_huge-%A.out    # Standard output of the script (Can be absolute or relative path). %A adds the job id to the file name so you can launch the same script multiple times and get different logging files
#SBATCH --error=/vol/aimspace/users/tuo/otis/slurm_output/fin/bm_huge-%A.err     # Standard error of the script
...
cmd="./bash_scripts/benchmark/finetune_BM_huge.sh"
echo $cmd && $cmd