...
#SBATCH --job-name=bm_base
#SBATCH --output=/vol/aimspace/users/tuo/otis/slurm_output/fin/bm_base-%A.out    # Standard output of the script (Can be absolute or relative path). %A adds the job id to the file name so you can launch the same script multiple times and get different logging files
#SBATCH --error=/vol/aimspace/users/tuo/otis/slurm_output/fin/bm_base-%A.err     # Standard error of the script
...
cmd="./bash_scripts/benchmark/finetune_BM_base.sh"
echo $cmd && $cmd